...
Texture::Texture()
{
	unopenedBox = loadTexture("image/unopenedBox.png");
	emptyBox = loadTexture("image/emptyBox.png");
	flag = loadTexture("image/flag.png");
	mine = loadTexture("image/mine.png");
	num1 = loadTexture("image/1.png");
	num2 = loadTexture("image/2.png");
	num3 = loadTexture("image/3.png");
	num4 = loadTexture("image/4.png");
	num5 = loadTexture("image/5.png");
	num6 = loadTexture("image/6.png");
	num7 = loadTexture("image/7.png");
	num8 = loadTexture("image/8.png");
}
